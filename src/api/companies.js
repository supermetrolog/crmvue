...
export default {
    ...
    async searchCompanies(query) {
        ...
        let url = "companies/search?" + query + "&expand=requests,contacts.emails,contacts.phones,contacts.contactComments,broker,companyGroup,consultant,productRanges,categories,files";
        let data = false;
        await axios
            .get(url)
            .then((Response) => {
