        ...
        <template v-if="answers[0].surveyQuestionAnswer">
            <template v-if="requests?.actual?.length">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <UiChip
                        v-for="requestId in requests.actual"
                        :key="requestId"
            ...
            <template v-if="requests?.archived?.length">
                <DashboardChip class="my-1 dashboard-bg-light"
                    >Архивированные запросы:</DashboardChip
                >
                <div class="d-flex gap-2 flex-wrap">
                    <UiChip
                        v-for="requestId in requests.archived"
                        :key="requestId"
...
const requests = computed(() => props.answers[0].surveyQuestionAnswer.value);
</script>
