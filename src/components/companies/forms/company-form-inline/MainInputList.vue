  ...
  <div class="main-input-list">
    ...
    >
      ...
      <div class="col-8 reproduce-input">
        ...
        ></i>
        <input type="text" v-model.lazy="this.MAIN.siteList[index]" />
        <i
          ...
          <div class="col-12">
            ...
            >
              <input
                class="checkbox"
                type="radio"
                v-model="this.MAIN.status"
                @click="test"
                value="1"
                id="radio-0"
              />
              <label class="checkbox-label" for="radio-0">актив</label>
              <input
                class="checkbox"
                type="radio"
                v-model="this.MAIN.status"
    ...
    <div class="input-group row no-gutters">
      <div class="col-4">
        <label class="input-label">Консультант</label>
      </div>
      <div class="col-8">
        <div class="row no-gutters">
          <div class="col-12">
            <select
              ...
              v-model="this.MAIN.consultant"
              @change="test"
            >
              <option value="532">Александр</option>
    ...
    <div class="input-group row no-gutters">
      ...
      <div class="col-8 pl-4">
        <div class="row">
          <div class="col-12">
            <input type="file" class="btn btn-primary btn-large" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    test() {
      console.log(this.MAIN.processed);
    },
    setDefaultName() {
      this.MAIN.nameEng = "";
      this.MAIN.nameRu = "";
