<template>
    <div class="survey-form-stepper-helper" data-tour-id="survey-form:stepper-helper">
        ...
        <span
            ...
            :key="question.id"
            class="survey-form-stepper-helper__question"
        >
            - {{ question.title }}
        </span>
        <svg
            class="survey-form-stepper-helper__icon survey-form-stepper-helper__icon--right"
            viewBox="0 0 24 24"
            height="48px"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
...
const questions = [
    {
        id: 1,
        title: 'Где сидит, кто рядом, почем?'
    },
    {
        id: 2,
        title: 'Есть ли субаренда на объекте?'
    },
    {
        id: 3,
        title: 'Продает ли оборудование?'
    },
    {
        id: 4,
        title: 'Планирует ли стройку?'
    },
    {
        id: 5,
