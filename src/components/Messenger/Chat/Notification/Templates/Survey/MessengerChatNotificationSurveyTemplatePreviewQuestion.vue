<template>
    <div class="messenger-quiz-question">
        ...
        <div v-if="hasCustomQuestions" class="text-left">
            <MessengerChatNotificationSurveyTemplatePreviewQuestionCustom :question />
        </div>
...
import MessengerChatNotificationSurveyTemplatePreviewQuestionCustom from '@/components/Messenger/Chat/Notification/Templates/Survey/MessengerChatNotificationSurveyTemplatePreviewQuestionCustom.vue';
