<template>
    <div class="messenger-quiz-form-template-offer">
        <div class="messenger-quiz-form-template-offer__row">
            <MessengerQuizFormTemplateOfferMixPreview
...
import MessengerQuizFormTemplateOfferMixPreview from '@/components/Messenger/Quiz/Form/Template/OfferMix/MessengerQuizFormTemplateOfferMixPreview.vue';
