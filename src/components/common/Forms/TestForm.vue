            ...
            <Form @submit="onSubmit">
                <Tabs :options="{ useUrlFragment: false }">
                    ...
                    <Tab name="Основное">
                        ...
                        <FormGroup>
                            <Input v-model="form.officeAddress" label="Адрес офиса" class="col-4 pr-1" />
                            <MultiSelect
                        ...
                        <FormGroup>
                            <PropogationInput v-model="form.contacts.phones" label="Телефон" class="col-4 pr-1" />
                            <PropogationInput v-model="form.contacts.emails" label="Email" class="col-4 pr-1" />
                            <PropogationInput v-model="form.contacts.websites" label="Вебсайт" class="col-4 pr-1" />
                        </FormGroup>
                        <FormGroup>
                            <MultiSelect
                        ...
                        <FormGroup>
                            <Textarea v-model="form.description" label="Описание" class="col-6 pr-1" />
                            <FileInput
                    ...
                    <Tab name="Реквизиты">
                        <FormGroup>
                            <Input v-model="form.legalAddress" label="Юр. адрес" class="col-8 pr-1" />
                        </FormGroup>
                        <FormGroup>
                            <Input v-model="form.ogrn" :v="v$.form.ogrn" label="ОГРН" class="col-4 pr-1" />
                            <Input v-model="form.inn" :v="v$.form.inn" label="ИНН" class="col-4 px-1" />
                            <Input v-model="form.kpp" :v="v$.form.kpp" label="КПП" class="col-4 pl-1" />
                        </FormGroup>
                        ...
                        <FormGroup>
                            ...
                            <Input
                                ...
                                class="col-4 px-1"
                            />
                            <Input v-model="form.inTheBank" label="В банке" class="col-4 pl-1" />
                        </FormGroup>

                        <FormGroup>
                            <Input v-model="form.bik" :v="v$.form.bik" label="БИК" class="col-4 pr-1" />
                            <Input v-model="form.okpo" :v="v$.form.okpo" label="ОКПО" class="col-4 px-1" />
                            <Input v-model="form.okved" :v="v$.form.okved" label="ОКВЭД" class="col-4 pl-1" />
                        </FormGroup>

                        <FormGroup>
                            <Input v-model="form.signatodyName" label="Имя подписанта" class="col-4 pr-1" />
                            <Input v-model="form.signatodyMiddleName" label="Фамилия подписанта" class="col-4 px-1" />
                            <Input v-model="form.signatodyLastName" label="Отчество подписанта" class="col-4 pl-1" />
                        </FormGroup>
                    </Tab>
    ...
    validations() {
        return {
            form: {
                ...
                inn: {
                    minLength: helpers.withMessage('инн не может быть меньше 12 символов', minLength(12))
                },
                kpp: {
                ...
                productRanges: {
                    required: helpers.withMessage('Выберите наменклатуру товаров', required)
                }
            }
        };
    },
    methods: {
        ...mapActions(['FETCH_CONSULTANT_LIST', 'FETCH_COMPANY_GROUP_LIST', 'CREATE_COMPANY', 'UPDATE_COMPANY']),
        onSubmit() {
            this.v$.$validate();
