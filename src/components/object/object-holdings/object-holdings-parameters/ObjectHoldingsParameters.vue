  ...
  <div class="ObjectHoldingsParameters">
    <div class="ObjectHoldingsParameters-main">
      <p class="ObjectHoldingsParameters-main-area">
        12652 м<sup>2</sup> (по этажам: 12662 м<sup>2</sup>)
      </p>
      <span class="ObjectHoldingsParameters-main-address"
        >Московская область, Фрязино, Свидетельская 34</span
      >
    </div>
    ...
    <div class="ObjectHoldingsParameters-provision">
      <div class="ObjectHoldingsParameters-provision-item">
        <i class="fas fa-arrow-up"></i>
        <span>1-15 метров</span>
      </div>
      <div class="ObjectHoldingsParameters-provision-item">
